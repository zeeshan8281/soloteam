...
export const metadata = {
  title: "SoloTeam Docs — Specialist capabilities",
  description: "The specialist capabilities behind the client-operations workflow.",
};
...
const AGENTS: { handle: string; name: string; does: string; use: string; examples: string[] }[] = [
  ...
  },
  {
    ...
    examples: ["research our top 3 competitors and how they price", "which client decision is blocking launch?", "draft a strategy memo on our Q3 focus"],
  },
  {
    handle: "@marketing",
    name: "Marketing",
...
export default function Roster() {
  return (
    <article>
      <PageHead kicker="docs / specialist capabilities" title="Specialists behind the workflow">
        <Lead>
          SoloTeam coordinates five specialist playbooks behind one client workflow. You can still address a specialist directly,
          but the product does not require you to manage five separate bots.
        </Lead>
      </PageHead>
